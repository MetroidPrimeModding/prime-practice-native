...
/* Special stuff to get it to work in prime-practice*/
#include "duk_mem.h"
//#define DUK_SNPRINTF rpl_snprintf
#define __WORDSIZE 32
#define DUK_VA_COPY(dest,src) do { (dest)[0] = (src)[0]; } while (0)
#define DUK_USE_FATAL_HANDLER(udata, msg) (*((int*)0) = *((int*)0xDEADBEEF))
#define DUK_UNREACHABLE() (*((int*)0) = *((int*)0xDEADBEE1))

#define DUK_ANSI_MALLOC(s) prime_malloc(0, s)
#define DUK_ANSI_REALLOC(p, s) prime_realloc(0, p, s)
#define DUK_ANSI_CALLOC(n, s) prime_calloc(0, n, s)
#define DUK_ANSI_FREE(p) prime_free(0, p)

#define DUK_USE_FILE_IO false
...
#define DUK_USE_TRACEBACK_DEPTH 20
