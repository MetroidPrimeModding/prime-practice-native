...
#define IMGUI_DISABLE_WIN32_DEFAULT_CLIPBOARD_FUNCTIONS // [Win32] Don't implement default clipboard handler. Won't use
                                                        // and link with OpenClipboard/GetClipboardData/CloseClipboard
                                                        // etc. (user32.lib/.a, kernel32.lib/.a)
#define IMGUI_DISABLE_WIN32_DEFAULT_IME_FUNCTIONS // [Win32] Don't implement default IME handler. Won't use and link
...
#define IMGUI_DISABLE_FILE_FUNCTIONS // Don't implement ImFileOpen/ImFileClose/ImFileRead/ImFileWrite and ImFileHandle
                                     // at all (replace them with dummies)
...
// to link with fopen/fclose/fread/fwrite. This will also disable the LogToTTY() function.
...
#define IMGUI_USE_ABGR_PACKED_COLOR
...
// vcpkg with 'vcpkg install freetype' + 'vcpkg integrate install'.
